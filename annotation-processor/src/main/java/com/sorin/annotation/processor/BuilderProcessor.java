package com.sorin.annotation.processor;
...
@SupportedAnnotationTypes("com.sorin.annotation.processor.BuilderProperty")
...
public class BuilderProcessor extends AbstractProcessor {
    ...
    public boolean process(
        ...
        for (TypeElement annotation : annotations) {
            ...
            final Map<Boolean, List<Element>> annotatedMethods = annotatedElements.stream().collect(Collectors
                    .partitioningBy(
            ...
            final Map<String, String> setterMap = setters.stream().collect(Collectors
